    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white font-sans selection:bg-[#B88B2A] selection:text-black">
      ...
      <nav className="border-b border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-50 px-6 py-4 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/dashboard')}>
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#B88B2A] to-[#E5C16C] p-[2px] flex items-center justify-center shadow-lg shadow-[#B88B2A]/10">
          ...
          <div>
            <h1 className="text-lg font-black tracking-tight text-slate-900 dark:text-white flex items-center gap-1.5">
              AI LEGAL<span className="text-[#B88B2A] text-xs font-bold uppercase tracking-widest px-2 py-0.5 rounded-full bg-[#B88B2A]/10 border border-[#B88B2A]/30">ENTERPRISE</span>
            </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#B88B2A] to-[#B08D3E] text-slate-950 font-bold text-xs hover:brightness-110 transition-all flex items-center gap-2 shadow-lg shadow-[#B88B2A]/20"
          >
      ...
      <section className="relative overflow-hidden px-6 pt-16 pb-20 text-center max-w-5xl mx-auto">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#B88B2A]/10 blur-[120px] rounded-full pointer-events-none" />

        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#B88B2A]/10 border border-[#B88B2A]/30 text-[#B88B2A] text-xs font-bold uppercase tracking-wider mb-6">
        ...
        <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-slate-900 dark:text-white mb-6 leading-tight">
          Enterprise Power for <span className="bg-gradient-to-r from-[#B88B2A] via-[#B08D3E] to-[#B88B2A] bg-clip-text text-transparent">Universities, Law Colleges & Institutions</span>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <button
            onClick={() => navigate('/dashboard/enterprise')}
            className="px-8 py-4 rounded-2xl bg-gradient-to-r from-[#B88B2A] to-[#B08D3E] text-slate-950 font-black text-sm hover:scale-105 transition-all flex items-center gap-3 shadow-xl shadow-[#B88B2A]/25"
          >
      ...
      <section className="max-w-6xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 shadow-sm hover:border-[#B88B2A]/40 transition-all">
