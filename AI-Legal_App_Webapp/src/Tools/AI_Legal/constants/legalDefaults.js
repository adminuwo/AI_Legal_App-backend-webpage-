...
export const DISCLAIMER_DEFAULTS = [
    {
        title: "1. Automated Advisory & Research Status",
        content: [
            {
                subtitle: "Informational & Research Purpose",
                text: "AI LEGAL™ is an artificial intelligence platform designed to augment legal research, workflow efficiency, and document drafting. Outputs generated by the platform—including statutory citations (BNS, BNSS, BSA, IPC, CrPC), case law digests, and draft clauses—do not constitute formal legal opinions or licensed legal representation."
            }
        ]
    },
    {
        ...
        content: [
            {
                subtitle: "No Attorney-Client Privilege",
                text: "Using AI LEGAL™ does not establish an attorney-client or advocate-client relationship under the Advocates Act, 1961 or Bar Council of India rules. Formal legal representation requires independent consultation with an enrolled advocate."
            }
        ]
    },
    {
        title: "3. Precedent Citation Verification Duty",
        content: [
            {
                subtitle: "Mandatory Cross-Verification",
                text: "Generative AI models may occasionally generate incomplete or overruled judicial citations. Practicing advocates are under a strict professional duty to independently cross-verify all case names, statutory sections, and citations against official law reporters before submitting them in court."
            }
        ]
    },
    {
        ...
        content: [
            {
                ...
                text: "Neither UNIFIED WEB OPTIONS & SERVICES PRIVATE LIMITED nor its developers assume liability for lost cases, dismissed petitions, or errors resulting from reliance on AI suggestions. Advocates and users remain solely responsible for their final filings."
            }
        ]
    }
];
