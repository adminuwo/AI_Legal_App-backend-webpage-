        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div onClick={() => navigate('/')} className="flex items-center gap-2.5 cursor-pointer select-none group">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-extrabold tracking-tight text-slate-900 dark:text-white flex items-center">
                AI Legal<span className="text-[10px] text-amber-500 dark:text-amber-400 font-extrabold ml-0.5">™</span>
              </span>
            </div>
          </div>
