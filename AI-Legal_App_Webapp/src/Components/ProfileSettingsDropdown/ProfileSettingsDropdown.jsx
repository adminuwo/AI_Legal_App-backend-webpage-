...
import GeneralUserAccountModal from '../GeneralUser/GeneralUserAccountModal';
...
const ProfileSettingsDropdown = ({ defaultTab, onClose, onLogout }) => {
    ...
    if (SHOW_GENERAL_USER_FLOW && selectedRole === 'general_user') {
        return <GeneralUserAccountModal defaultTab={defaultTab} onClose={onClose} onLogout={onLogout} />;
    }
                    ...
                    <div className="sticky top-0 z-20 px-3.5 sm:px-8 py-3 sm:py-5 flex items-center justify-between gap-2.5 bg-white dark:bg-[#1E293B] border-b border-slate-100 dark:border-slate-800 shrink-0">
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
                            <button
                                ...
                                className={`px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-xs font-bold transition-all border cursor-pointer whitespace-nowrap shrink-0 ${isEditing
                                    ...
                                    {selectedRole === 'student' ? (
                                        ...
                                        <div className="bg-[#B88B2A]/8 dark:bg-[#B88B2A]/10 border border-[#B88B2A]/20 dark:border-[#B88B2A]/30 rounded-2xl p-3.5 sm:p-6">
                                            <div className="flex items-center justify-between flex-wrap gap-3 mb-6">
                                                ...
                                                <div className={`flex items-center gap-1.5 px-3 py-1 border rounded-lg text-[10px] font-black uppercase tracking-widest ${profileForm.barNumber
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-lg text-[10px] font-bold transition-all border ${aspect === opt.value
